...
def send_download_alert(user_name, user_id, user_email, unformattedDict, fileName):
    ...
    message = Mail(
        ...
        html_content="Hey " + user_name + "! <br> <br> Hespr's user account download system would like to inform you that User <strong>" + user_name + "</strong>, has requested to download their account data which has been attached to this email. Thank you for using our app! <br> <br> Sincerely,<br> Ethan Talreja, Krishna Nair, Spencer Chubb, and rest of the Hespr team"
        )
...
def dict_convert_formatted(unformattedDict, fileName):
    ...
    with open(absoluteFileName, 'w', encoding='utf-8') as f:
        json.dump(unformattedDict, f, ensure_ascii=False, indent=4, default=str, sort_keys=True)
